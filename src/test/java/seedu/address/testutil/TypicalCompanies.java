...
public class TypicalCompanies {
    ...
    public static final Company AMY = new CompanyBuilder().withName(VALID_COMPANY_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Company BOB = new CompanyBuilder().withName(VALID_COMPANY_BOB).withPhone(VALID_PHONE_BOB)
