...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                COMPANY_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                new AddCommand(expectedCompanyMultipleTags));
    }

    @Test
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedcompaniestring = COMPANY_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND;

        // multiple names
        assertParseFailure(parser, COMPANY_DESC_AMY + validExpectedcompaniestring,
        ...
        assertParseFailure(parser,
                validExpectedcompaniestring + PHONE_DESC_AMY + EMAIL_DESC_AMY + COMPANY_DESC_AMY + ADDRESS_DESC_AMY
                        + validExpectedcompaniestring,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_COMPANY, PREFIX_ADDRESS, PREFIX_EMAIL, PREFIX_PHONE));

        // invalid value followed by valid value

        // invalid name
        assertParseFailure(parser, INVALID_COMPANY_DESC + validExpectedcompaniestring,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_COMPANY));
        ...
        // invalid name
        assertParseFailure(parser, validExpectedcompaniestring + INVALID_COMPANY_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_COMPANY));
