...
public class EditCommandParserTest {
    ...
    public void parse_batchEditInvalidIndices_failure() {
        ...
        assertParseFailure(parser, "1,abc" + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);

        // Zero index
        assertParseFailure(parser, "0,1" + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);

        // Negative index
        assertParseFailure(parser, "1,-2" + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);

        // Empty indices
        assertParseFailure(parser, "1," + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);
        assertParseFailure(parser, ",2" + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);
        assertParseFailure(parser, "1,,3" + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);
    }
    ...
    public void parse_batchEditOutOfIntegerRange_failure() {
        ...
        assertParseFailure(parser, "1," + largeNumber + TAG_DESC_PENDING_APPLICATION, MESSAGE_INVALID_INDICES);
    }
}
